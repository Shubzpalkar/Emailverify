...
import { UserCircle, Gear, ShieldCheck, CreditCard, Key, ChartLineUp, Trash, Buildings, Users } from '@phosphor-icons/react';
    ...
    <div className="container page-enter account-layout-wrapper">
      <div className="account-sidebar glass-card">
        ...
        <nav className="account-nav">
          ...
          <PermissionGuard permission="workspace.view">
            <NavLink to="/account/workspace" className={({isActive}) => isActive ? "account-nav-link active" : "account-nav-link"}>
              <Buildings size={20} /> Workspace
            </NavLink>
          </PermissionGuard>
          
          <PermissionGuard permission="team.view">
            <NavLink to="/account/team" className={({isActive}) => isActive ? "account-nav-link active" : "account-nav-link"}>
              <Users size={20} /> Team Members
            </NavLink>
          </PermissionGuard>
          
          <PermissionGuard permission="workspace.settings">
            <NavLink to="/account/workspace-settings" className={({isActive}) => isActive ? "account-nav-link active" : "account-nav-link"}>
              <Gear size={20} /> Workspace Settings
            </NavLink>
          </PermissionGuard>
